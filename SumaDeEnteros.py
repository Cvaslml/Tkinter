...
titulo.config(bg="black", fg="yellow", font=("Calibri", 15))
...
Label_x.config(fg="green", font=("Calibri", 15))
Label_x.place(x=250, y=45)

# Caja de texto para X
entry_x = tk.Entry(frame_entrada)
entry_x.config(font=("Calibri", 13))
entry_x.focus_set()
entry_x.place(x=290, y=50)

# Etiqueta Y
Label_y = tk.Label(frame_entrada, text= "Y =")
Label_y.config(fg="green", font=("Calibri", 15))
Label_y.place(x=250, y=95)

# Caja de texto para Y
entry_y = tk.Entry(frame_entrada)
entry_y.config(font=("Calibri", 13))
entry_y.focus_set()
